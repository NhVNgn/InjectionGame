...
public class Patient extends BaseBt implements ArmInterface{

	public Patient(double xPos, double yPos, double scale, String file) {
...
//		System.out.println("base-patient-called");
		g2.setTransform(transform);
	}
