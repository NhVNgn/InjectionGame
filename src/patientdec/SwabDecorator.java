...
public class SwabDecorator extends ArmDecorator {
	
	public SwabDecorator(ArmInterface patient ,double xPos, double yPos, double scale, String file) {
	...
	private void decorateWithSwab(Graphics2D g2) {
